...
class Fishing:
    def __init__(self, delay=0.1, max_step=100, show_det=True, predictor=None):
        ...
        exit_pos[0] - 32, exit_pos[1] - 19, DEFAULT_MONITOR_WIDTH, DEFAULT_MONITOR_HEIGHT)
    ...
    def get_state(self, all_box=False):
        ...
        if self.show_det:
            ...
            fontScale = 1
            thickness = 1
            cv2.putText(img, str(self.last_score), (257 + 30, 72), fontScale=fontScale, fontFace=fontFace,
                        thickness=thickness, color=(0, 255, 255))
            cv2.putText(img, str(self.reward), (257 + 30, 87), fontScale=fontScale, fontFace=fontFace,
                        thickness=thickness, color=(255, 255, 0))
    ...
    def step(self, action):
        ...
        return self.get_state(), self.reward, (
                    self.step_count > self.max_step or (self.zero_count >= 15 and self.fish_start) or score > 176)
